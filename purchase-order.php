        ...
        <main class="main-wrapper">
            ...
            <section class="main-content-wrapper d-flex flex-column">
                ...
                <div class="main-inventory-button d-flex align-items-center">
                    <button class="d-flex align-items-center justify-content-center" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#email-supplier" style="gap: 5px;">Email Supplier <img src="./assets/images/icons/check.png" alt=""></button>
